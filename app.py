...
# Comparativo de Métricas Derivadas
...
if modo_avancado:
    ...
    st.markdown("#### Relação entre Internações per Capita e IDHM")
    fig_corr3 = px.scatter(df, x="IDHM (2010)", y="INT_PER_CAPITA", color="city", trendline="ols")
